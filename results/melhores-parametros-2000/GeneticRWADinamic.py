...
class WDMSimulator:
    ...
    def __init__(self,
        ...
        self.population_size = 69
        self.num_generations = 248
        self.crossover_rate = 0.57
        self.mutation_rate = 0.86
    ...
    def _fitness_route(self, route: List[int]) -> float:
        ...
        fitness = (0.37 * (1 / (hops + 1)) +
                   0.62 * (1 / (wavelength_changes + 1)))
...
def main():
    ...
    # Executa simulação
    results = wdm_simulator.simulate_network(num_simulations=20)  # numero de simulações
